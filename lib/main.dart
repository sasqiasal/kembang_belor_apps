  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: MultiBlocProvider(
        providers: [
          BlocProvider(create: (context) => TourismBloc(sl())),
          BlocProvider(create: (context) => RecentlyTourismBloc(sl())),
          BlocProvider(create: (context) => PaymentBloc(sl())),
          ...
          BlocProvider(create: (context) => InsertCollabBloc(sl())),
          BlocProvider(create: (context) => CollabHistoryBloc(sl())),
          BlocProvider(create: (context) => LocalTicketBloc(sl(), sl(), sl()))
        ],
        child: MaterialApp(
          title: 'Flutter Demo',
          theme: theme(),
